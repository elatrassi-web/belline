...
$dbss=array();
$dbss['host']='185.98.131.160';      // Database host (in most cases 'localhost', on Windows systems - use '127.0.0.1' instead of 'localhost' to avoid a php/ipv6 bug)
$dbss['user']='belli2103971';      // Database user
$dbss['pass']='@Loutinette1840';      // Database password
$dbss['name']='belli2103971';      // Database name. Note that the installation script cannot create a database for you!
